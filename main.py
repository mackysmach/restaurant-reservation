...
#     r=collection.find({"name":name},{"_id":0,"name":1,"time":1,"table_number":1})
#     my_result=[]
#     for i in r:
#         my_result.append(i)
#     return{
...
#     r=collection.find({"table_number":table},{"_id":0,"name":1,"time":1,"table_number":1})
#     my_result=[]
#     for i in r:
#         my_result.append(i)
#     return{
...
#     r=collection.find_one({"time":reservation.time,"table_number":reservation.table_number},{"_id":0})
#     if(r!=None):
#         return{
